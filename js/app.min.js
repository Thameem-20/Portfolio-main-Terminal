...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Ahmad Thameem"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Ahmad Thameem</td></tr>
					<tr><td>Profession</td><td>Software developer</td></tr>
					<tr><td>Sex</td><td>Male</td></tr>
					<tr><td>Resume</td><td><a href="/resume/2023.pdf" download>Download Resume</a></td></tr>
					<tr><td>Portfolio</td><td><a href="https://thameem-kmh48rx4a-thameem-20s-projects.vercel.app/" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:ahmedthameem20"><i class="fas fa-envelope"></i></a>
              <a href="https://"><i class="fab fa-skype"></i></a>
              <a href="https://t.me/"><i class="fab fa-telegram"></i></a>
              <a href="https://github.com/Thameem-20" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Ahmad" -lastName "Thameem"',
        typing: true,
      },
      {
        text: "loading...",
